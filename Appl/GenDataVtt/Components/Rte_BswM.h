...
FUNC(uint8, RTE_CODE) Rte_Mode_BswM_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_BatteryMode_BswM_MDGP_BatteryMode(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_Mode_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_BatteryMode_BswM_MDGP_BatteryMode Rte_Mode_BswM_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_BatteryMode_BswM_MDGP_BatteryMode
