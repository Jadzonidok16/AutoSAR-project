 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: NvM_Cfg.c
 *   Generation Time: 2024-04-12 15:49:33
...
static VAR(uint8, NVM_PRIVATE_DATA) CpApAFSControllerSnNvMPimPassingLaneF_Crc_au8[2UL]; 
...
NVM_SELECT_BLOCK_FOR_WRITEALL_ON
      ...
      { /*  CpApAFSControllerSnNvMPimPassingLaneF  */ 
        (NvM_RamAddressType)&Rte_CpApAFSController_PimPassingLane /*  pointer to the RAM data buffer  */ , 
        NULL_PTR /*  pointer to the ROM buffer  */ , 
        NULL_PTR /*  pointer to the Init Callback function  */ , 
        NULL_PTR /*  pointer to the job End Callback function  */ , 
        NULL_PTR /*  pointer to the ReadRamBlockFromNvCallback  */ , 
        NULL_PTR /*  pointer to the WriteRamBlockToNvCallback  */ , 
        CpApAFSControllerSnNvMPimPassingLaneF_Crc_au8 /*  pointer to the CRC data buffer  */ , 
...
struct PermanentRamBlockLengthChecks {
  ...
  NvM_LengthCheck Block_CpApAFSControllerSnNvMPimPassingLaneF : SizeOfRamBlockDoesNotMatchConfiguredLength(Rte_CpApAFSController_PimPassingLane, 0, 1U);
