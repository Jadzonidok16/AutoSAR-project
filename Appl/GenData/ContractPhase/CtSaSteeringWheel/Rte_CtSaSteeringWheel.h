...
FUNC(uint8, RTE_CODE) Rte_Mode_CtSaSteeringWheel_PpBatteryMode_BatteryMode(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 * Rte_Mode_<p>_<m>
 *********************************************************************************************************************/
# define Rte_Mode_PpBatteryMode_BatteryMode Rte_Mode_CtSaSteeringWheel_PpBatteryMode_BatteryMode
